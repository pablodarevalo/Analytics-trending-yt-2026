...
This project analyzes global YouTube trends during a critical point in time (February 26, 2026), unifying data from 10 regions to identify consumption patterns and interaction efficiency.

## 📁 Project Overview
* **Status:** Completed
* **Data Source:** YouTube Trending Dataset (Global)
* **Objective:** Identify peak engagement windows and regional loyalty variations.
